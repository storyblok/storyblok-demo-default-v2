...
<template>
  <div class="relative" :class="layout === 'split' ? 'px-4 md:px-8 py-12 md:pt-20 lg:p-0' : 'px-4 md:px-8 lg:px-0 translate-y-12 md:translate-y-24'">
    <div class="relative z-10">
      <DecorationImageTopLeft v-if="blok.image_decoration" class="absolute left-0 top-0 translate-x-[-35px] translate-y-[-35px] scale-50 md:translate-x-[-40px] md:translate-y-[-50px] md:scale-100" />
